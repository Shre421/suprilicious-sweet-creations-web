...
const CategoryCard: React.FC<CategoryProps> = ({
  ...
  return <div className="product-card group">
      <div className="h-48 overflow-hidden relative">
        <img src={image} alt={title} className="w-full h-full group-hover:scale-105 transition-transform duration-300 object-cover" />
      ...
      <div className="p-6">
        ...
        <Link to={link} className="text-bakery-orange font-medium text-sm hover:underline inline-flex items-center">
          Explore Products
...
const ProductCategories: React.FC = () => {
  ...
  return <section id="categories" className="section-padding bg-bakery-cream">
